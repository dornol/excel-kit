package io.github.dornol.excelkit.example.app.book.infrastructure;
...
public class BookDataInitializer implements CommandLineRunner {
    ...
    private String randomText(int minLength, int maxLength) {
        ...
        for (int i = 0; i < len; i++) {
            ...
            if (r < 10) ch = (char) ('0' + r); // digit
            else ch = (char) ('a' + r - 10);   // lowercase letter
            sb.append(ch);
        }
        return sb.toString();
    }
