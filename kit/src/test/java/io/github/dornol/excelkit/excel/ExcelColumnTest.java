...
class ExcelColumnTest {
    ...
    void constructor_shouldCreateInstanceWithValidParameters() {
        ...
        // Act
        ExcelColumn<String> column = new ExcelColumn<>(name, function, cellStyle, columnSetter, 0, 0, false, null, null, null);
    ...
    void applyFunction_shouldReturnFunctionResult() {
        ...
        ExcelColumn<String> column = new ExcelColumn<>(name, testFunction, cellStyle, columnSetter, 0, 0, false, null, null, null);
    ...
    void applyFunction_shouldReturnNullWhenFunctionThrowsException() {
        ...
        ExcelColumn<String> column = new ExcelColumn<>(name, exceptionFunction, cellStyle, columnSetter, 0, 0, false, null, null, null);
    ...
    void setColumnData_shouldHandleExceptionFromColumnSetter() {
        ...
        ExcelColumn<String> column = new ExcelColumn<>(name, function, cellStyle, exceptionSetter, 0, 0, false, null, null, null);
