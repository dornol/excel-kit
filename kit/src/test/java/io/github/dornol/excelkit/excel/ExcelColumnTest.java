...
class ExcelColumnTest {
    ...
    void constructor_shouldCreateInstanceWithValidParameters() {
        ...
        // Act
        ExcelColumn<String> column = ExcelColumn.of(name, function, cellStyle, columnSetter);
    ...
    void setColumnData_shouldHandleExceptionFromColumnSetter() {
        ...
        ExcelColumn<String> column = ExcelColumn.of(name, function, cellStyle, exceptionSetter);
